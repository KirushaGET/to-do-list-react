  ...
  const EditIsCheck = async(index) => {
    ...
    return (
      <div className='textEdit'>
        <input className='checkbox' type='checkbox' checked={value.isCheck} onChange={() => EditIsCheck(index)}/>
        <input className='text-task1' type='text' value={text} onChange={(e) => setText(e.target.value)}/> 
